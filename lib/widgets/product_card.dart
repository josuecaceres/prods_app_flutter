      ...
      child: Container(
        ...
        child: Stack(
          ...
          children: <Widget>[
            ...
            _ProductDetails(idProd: product.id!, nameProd: product.name),
            Positioned(
              top: 0,
              right: 0,
...
class _PriceTap extends StatelessWidget {
  ...
  const _PriceTap(this.priceProd);
...
class _ProductDetails extends StatelessWidget {
  ...
  const _ProductDetails({required this.nameProd, required this.idProd});
